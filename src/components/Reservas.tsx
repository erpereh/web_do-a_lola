...
const Reservas = () => {
  ...
  const inputClass = "w-full bg-input border border-border rounded-lg px-4 py-3 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-primary";
  const labelClass = "block text-xs text-primary/70 mb-1 font-medium tracking-wide";
  ...
  return (
    <section id="reservas" className="py-20 md:py-32 px-4" ref={ref}>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-10 md:mb-16">
          {/* Contact info — card */}
          <motion.div
          ...
          >
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="bg-card border border-border rounded-2xl p-6 md:p-8 space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full bg-primary text-primary-foreground py-3 rounded-full font-medium transition-all duration-300 hover:shadow-[0_0_28px_rgba(201,168,76,0.45)] hover:brightness-110"
                >
                  Solicitar reserva
                </button>
